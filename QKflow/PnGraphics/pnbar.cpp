...
QVariant PnBar::itemChange(QGraphicsItem::GraphicsItemChange
                           change,
  ...
  if (change == ItemSelectedChange) {
    if(value == true) {
      ...
      QString txt;
      txt.append(tr("Id: ")).append(QString::number(id_)).append(
        tr("\n"));

      txt.append("Voltage: ").append(QString::number(abs(
                                       v_))).append(" | ").append(
                                         QString::number(arg(v_))).append("º [V]\n");

      txt.append(tr("Current: ")).append(QString::number(abs(
                                           getI()))).append(" | ").append(QString::number(arg(
                                               getI()))).append("º [A]\n");

      txt.append("Genetared: ").append(QString::number(
                                         sg_.real()));
      ...
      txt.append("Consumed: ").append(QString::number(
                                        sl_.real()));
