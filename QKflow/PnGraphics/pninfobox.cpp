...
void PnInfoBox::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option);
    Q_UNUSED(widget);
    ...
    QRectF main_rect = QRectF(-kBoxWidth/2, -kBoxHeight -10, kBoxWidth, kBoxHeight);
